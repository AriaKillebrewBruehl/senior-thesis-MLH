...
cv::Mat caboodle(std::string path, cv::Mat img, bool saving) {
    ...
    std::cout << "Beginning fully automated hedcut detection." << std::endl;
    ...
    std::cout << "Beginning dot adjustment, THIS PROCESS IS SLOW." << std::endl;
    ...
    std::cout << "Sized dots, done." << std::endl;
